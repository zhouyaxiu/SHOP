  ...
  <div class="userorder">
    <el-header>
      <div class="toolbar f14">
        ...
        <span
          :class="[{ ec7: activeIndex == 0 }, 'cursor']"
          @click="tabHandler(0)"
          >全部订单</span
        >
        <el-divider direction="vertical" />
        <span
          :class="[{ ec7: activeIndex == 1 }, 'cursor']"
          @click="tabHandler(1)"
          >待发货</span
        >
        <el-divider direction="vertical" />
        <span
          :class="[{ ec7: activeIndex == 2 }, 'cursor']"
          @click="tabHandler(2)"
          >待收货</span
        >
        <el-divider direction="vertical" />
        <span
          :class="[{ ec7: activeIndex == 3 }, 'cursor']"
          @click="tabHandler(3)"
          >已取消</span
        >
        <el-divider direction="vertical" />
        <span
          :class="[{ ec7: activeIndex == 4 }, 'cursor']"
          @click="tabHandler(4)"
          >已完成</span
        >
      </div>
        ...
        <el-card class="box-card marginb10">
          <template #header>
            <div class="f12 flex b99 acenter c999">
              <span class="flex1"
                >订单号：9198383838 下单时间：2022-11-11 12:00:00</span
              >
              <span>已收货</span>
            </div>
          </template>
            ...
            <el-row :gutter="10" align="middle">
              ...
              <el-col :span="4">
                <div class="center">
                  ...
                  <div class="marginb6">
                    <el-button plain class="custom_plain_btn"
                      >订单详情</el-button
                    >
                  </div>
                  <div>
